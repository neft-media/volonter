...
const heroes = [
  {
    ...
    video: "uBZ1VLiRfEY?si=bYl4JM4M-kjTZjpk",
    interviewText: (
      <>
        <p>
          ...
          Она&nbsp;уверена: общее дело, будь&nbsp;то&nbsp;экологическая акция
          на&nbsp;Крайнем Севере или&nbsp;помощь детскому дому в&nbsp;Тюмени,
          объединяет и&nbsp;сплачивает.
        </p>
        <p>
          Недавно Гульнара с&nbsp;коллегами запустила свой волонтерский
          проект&nbsp;&mdash; про&nbsp;обучение финансовой грамотности ямальских
          школьников. Почему кажется важным развивать это&nbsp;направление
          и&nbsp;почему не&nbsp;сможет ограничиться только&nbsp;им,
          она&nbsp;рассказала NEFT.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    job: (
      <>
        руководитель направления
        <br />
        в&nbsp;управлении исполнением договоров
      </>
    ),
    ...
    interviewText: (
      <>
        <p>
          ...
          и&nbsp;Омске. Рассказывает, что&nbsp;получает удовольствие, когда
          помогает кому-то. Переехав в&nbsp;Тюмень, устроилась работать
          ...
          к&nbsp;всероссийскому движению
          &laquo;28&nbsp;петель&raquo;&nbsp;&mdash; для&nbsp;помощи недоношенным
          малышам и&nbsp;их&nbsp;мамам.
        </p>
        <p>
          Мы&nbsp;узнали, почему Елене близко добровольчество
          и&nbsp;как&nbsp;оно&nbsp;влияет на&nbsp;ее&nbsp;профессиональную
          деятельность.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    video: "C6pFOTKbbCw?si=-9NEilnAmdBmU2X-",
    interviewText: (
      <>
        <p>
          Для&nbsp;Виталия спорт&nbsp;&mdash; это и&nbsp;хобби, и&nbsp;работа.
          Его&nbsp;волонтерство началось с&nbsp;разовых соревнований
          и&nbsp;мастер-классов для&nbsp;детей из&nbsp;отдаленных ямальских
          поселков, позже переросло в&nbsp;большой социальный проект
          &laquo;Все&nbsp;на&nbsp;матч&raquo;.
        </p>
        <p>
          Зачем Виталий занимается с&nbsp;детьми, как&nbsp;совмещает работу
          на&nbsp;Новопортовском промысле и&nbsp;тренировки, а&nbsp;также
          чья&nbsp;поддержка для&nbsp;него особенно важна, узнаете
          из&nbsp;интервью.
        </p>
      </>
    ),
